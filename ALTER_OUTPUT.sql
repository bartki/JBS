...
/
ALTER TABLE JG_OBSERVED_OPERATIONS
ADD CONSTRAINT JG_OBOP_OPERATION_TYPE CHECK (OPERATION_TYPE IN ('INSERT', 'UPDATE', 'DELETE', 'SKIPPED'))
/
ALTER TABLE JG_OBSERVED_OPERATIONS
...
/
ALTER TABLE JG_OUTPUT_LOG
ADD CONSTRAINT JG_OULO_STATUS CHECK (STATUS IN ('READY', 'PROCESSED', 'ERROR'))
/
